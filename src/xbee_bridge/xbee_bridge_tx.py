...
if __name__ == '__main__':
    ...
    #topic = rospy.get_param("~topic", "/turtle1/pose")
    #topic_type = rospy.get_param("~topic_type", "turtlesim/Pose")
    #port = rospy.get_param("~port", "/dev/ttyUSB0")
    #rate = rospy.get_param("~rate", 57600)
    #queue = rospy.get_param("~queue_size", 5)
    XbeeBridge(port, rate, topic, topic_type, queue)
